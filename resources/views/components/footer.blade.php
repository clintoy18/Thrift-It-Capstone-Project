...
<footer class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <!-- Brand Column -->
            <div>
                <h2 class="text-xl font-bold text-gray-900 mb-4">THRIFT-IT</h2>
            ...
            <div>
                ...
                <div class="space-y-2">
                    <p class="text-gray-600">ThriftIt@gmail.com</p>
                    <p class="text-gray-600">Uc Main Sancianqko St, Avocado Bldg, 5th Floor</p>
                    <p class="text-gray-600">+1234 567 7890</p>
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-gray-600 mb-4">Yes, we are social!</p>
                <div class="flex space-x-4">
                    <a href="#" class="bg-white rounded-full p-2 text-black border border-black hover:bg-gray-100 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M22.675 0h-21.35C.593 0 0 .593 0 1.326v21.348C0 23.407.593 24 1.326 
                            24H12.82v-9.294H9.692V11.01h3.128V8.414c0-3.1 1.893-4.788 4.659-4.788 
        ...
        <div class="text-center text-gray-500 text-sm">
            © {{ date('Y') }} Thrift-IT. All rights reserved
        </div>
    </div>
</footer> 