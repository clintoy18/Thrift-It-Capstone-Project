<nav
    ...
    <div class="max-w-7xl mx-auto" x-data="{ mobileMenuOpen: false }">
                    ...
                    @if ($role !== 2)
                        ...
                        <div id="notif-bell" x-data="{
                            ...
                            <div x-show="open" @click.away="open = false" x-transition
                                class="absolute right-20 mt-2 w-72 bg-white dark:bg-gray-800 dark:text-gray-300 shadow-lg rounded-xl overflow-hidden z-50 border border-gray-200">
        ...
        hover:bg-[#a08e77] hover:scale-105 transition-all duration-200 w-[100px]">Login</a>
            ...
            <!-- Mobile Navbar -->
            <div
                class="flex items-center justify-between  text-gray-800 md:hidden w-full px-4 py-1 bg-[#F4F2ED]  dark:bg-gray-800 dark:text-gray-200">
                <!-- Search Bar -->
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button @click="mobileMenuOpen = !mobileMenuOpen"
                        class="p-2 rounded-md  dark:bg-gray-800 text-gray-700 hover:bg-gray-200 focus:outline-none">
            ...
            <div x-show="mobileMenuOpen" x-transition
                class="fixed top-[90px] left-0 right-0 bg-white shadow-lg border-t dark:bg-gray-800 dark:text-gray-200 text-gray-700 border-gray-200 md:hidden z-40 max-h-[70vh] overflow-y-auto">
                <div class="flex flex-col space-y-0 px-4 py-4">
                    @auth
                        ...
                        <div x-data="{ mobileSettingsOpen: false }"
                            class="relative border-b  dark:bg-gray-800 dark:text-gray-300 border-gray-100">
                            ...
                            <div x-show="mobileSettingsOpen" x-transition
                                class="ml-4 mt-2 space-y-0 pb-2  dark:bg-gray-800 dark:text-gray-200">
                                <!-- Personal Information -->
                                <div class="px-2 py-1">
                                    <span
                                        class="text-xs font-semibold  dark:bg-gray-800 dark:text-gray-200 text-gray-500 uppercase tracking-wide">Personal
                                        Information</span>
                                </div>
                                <a href="{{ route('profile.edit') }}#profile-information"
