            ...
            <div class="flex flex-col md:hidden text-center relative font-poppins">
                ...
                <div class="bg-white/70 dark:bg-gray-700/60 rounded-lg p-4 shadow-sm text-left">
                    ...
                    <ul class="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                        <li class="flex items-start"><span class="text-[#B59F84] mr-2">✓</span> Earn from your pre-loved fashion</li>
                        <li class="flex items-start"><span class="text-[#B59F84] mr-2">✓</span> Reduce clothing waste and pollution</li>
                        <li class="flex items-start"><span class="text-[#B59F84] mr-2">✓</span> Connect with conscious buyers</li>
                    </ul>
                </div>
                ...
                <!-- Tag -->
                <span class="absolute bottom-1 right-1 bg-[#F8EED6] px-2 py-0.5 rounded-full text-xs text-[#634600] font-medium shadow">
                    Circular Fashion
                </span>
            </div>
    ...
    <div class="py-6 bg-white dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('products.create') }}" class="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 rounded-full bg-[#B59F84] text-white shadow-sm hover:bg-[#a08e77] active:scale-[.98] transition">
