            ...
            <div class=" bg-white  shadow-lg rounded-lg overflow-hidden">
                <div class="p-6">
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="space-y-4">
                            <h3 class="text-lg font-medium text-[#000000] dark:text-[#000000]">Product Details</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="condition" class="block text-sm font-mediumtext-[#000000] dark:text-[#000000]">Condition</label>
                                ...
                                <div>
                                    <label for="listingtype" class="block text-sm font-medium text-[#000000] dark:text-[#000000]">Listing Type</label>
                            ...
                            <div id="price-field">
                                <label for="price" class="block text-sm font-medium text-[#000000] dark:text-[#000000]">Item Price</label>
