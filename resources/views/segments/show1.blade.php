...
<div class="w-full bg-[#F4F2ED] dark:bg-gray-800 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-12">
            ...
            <div class="hidden md:flex md:flex-row md:items-center">
                ...
                <!-- Image for Desktop -->
                <div class="md:w-[1900px] h-[400px] flex flex-row gap-[-30] relative p-6 left-[70px] top-[55px] overflow-hidden">
                    <div class=" flex relative right-[100px]">

                   
                    <img src="{{ asset('images/image 34.png') }}" alt="Thrift-IT Sustainable Fashion" class="w-full flex relative left-[180px] max-h-[200px] object-contain">
                    <img src="{{ asset('images/image 132.png') }}" alt="Thrift-IT Sustainable Fashion" class="w-full  flex relative left-[90px] top-[50px] max-h-[240px] object-contain">
                    <img src="{{ asset('images/image 128.png') }}" alt="Thrift-IT Sustainable Fashion" class="w-full flex relative top-[70px] max-h-[260px] object-contain">
                    <img src="{{ asset('images/image 129.png') }}" alt="Thrift-IT Sustainable Fashion" class="w-full flex relative top-[60px] right-[60px] max-h-[200px] object-contain">
                    <img src="{{ asset('images/image 128.png') }}" alt="Thrift-IT Sustainable Fashion" class="w-full flex relative right-[80px] bottom-[0px] max-h-[200px] object-contain">
                </div>
                </div>
            </div>
        </div>
